...
[Defines]
  PLATFORM_NAME                  = StarshorsePkg
  PLATFORM_GUID                  = 0458dade-8b6e-4e45-b773-1b27cbda3e06
  PLATFORM_VERSION               = 0.01
  DSC_SPECIFICATION              = 0x00010006
  OUTPUT_DIRECTORY               = Build/StarshorsePkg
...
#  AppPkg/Applications/Hello/Hello.inf        # No LibC includes or functions.
   StarshorsePkg/Applications/GetHttpdata/GetHttpdata.inf
   StarshorsePkg/Applications/GetHttpdata/EFI_SetTime.inf
...
#RICHARD-CHOI !include AppPkg/Applications/Sockets/Sockets.inc
